...
function load() {
    document.getElementById('ytbtn').addEventListener('mouseover', () => {
        document.getElementById('mode-desc').innerHTML = "Kies de meer gestreamde track tussen Zwangere Guy's 50+ liedjes"
    })
...
function setInfo(number, info) {
    ...
    <div class="option-cont">
        ...
        <div class="opt-info" id="${number}-info">
            ...
            <div id="${number}-buttons" class="opt-buttons" style="display: none">
                <button class="higher-btn" onclick="guess(true, ${number})">Hoger &#9650;</button><br>
                <button class="lower-btn" onclick="guess(false, ${number})">Lager &#9660;</button>
            </div>
        </div>
    </div>`
    ...
    document.getElementById(number + '-views').innerHTML = 'keer beluisterd'
    document.getElementById(number + '-has').innerHTML = 'werd'
...
function lose() {
    ...
    document.getElementById('lose-score').innerHTML = `Je behaalde een score van ${score}!`
}
